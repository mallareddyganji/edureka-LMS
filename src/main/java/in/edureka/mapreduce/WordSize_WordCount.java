 ...
 * @since 13-Apr-2014
 * @package in.edureka.mapreduce
 * @copyright Copyright (c) 2014 edureka! [www.edureka.in] <p> The Alphabet program counts the number of times words of same length have appeared in
 *            the input file. We write a map reduce code to achieve this, where mapper makes key value pair from the input file and reducer does
...
public class WordSize_WordCount {
	...
	/**
	 * @author edureka!
	 * @interface Mapper <p> Map class is static and extends MapReduceBase and implements Mapper interface having four hadoop generics type
	...
	public static class Map extends Mapper<LongWritable, Text, IntWritable, Text> {
		...
		// Mapper
		/**
		 * @method map <p> This method takes the input as text data type and splits the input into words. Now the length of each word in the input is
		 *         determined and key value pair is made. This key value pair is passed to reducer.
		 ...
		 * (non-Javadoc)
		 * 
		 * @see org.apache.hadoop.mapred.Mapper#map(java.lang.Object, java.lang.Object, org.apache.hadoop.mapred.OutputCollector,
	...
	/**
	 * @author edureka!
	 * @interface Reducer <p> Reduce class is static and extends MapReduceBase and implements Reducer interface having four hadoop generics type
	...
	public static class Reduce extends Reducer<IntWritable, Text, IntWritable, IntWritable> {
		...
		/**
		 * @method reduce <p> This method takes the input as key and list of values pair from mapper, it does aggregation based on keys and produces
		 *         the final output.
	...
	// Driver
	/**
	 * @method main <p> This method is used for setting all the configuration properties. It acts as a driver for map reduce code.
	 * @return void
