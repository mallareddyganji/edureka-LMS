...
/**
 * The Patent program finds the number of sub-patents associated with each id in the provided input file. We write a map reduce code to achieve this,
 * where mapper makes key value pair from the input file and reducer does aggregation on this key value pair.
 */
public class Patent {

	// Map class is static and extends MapReduceBase and implements Mapper interface having four hadoop generics type LongWritable, Text, Text, Text.
	...
	public static class Map extends Mapper<LongWritable, Text, Text, Text> {
		...
		/*
		 * This method takes the input as text data type and and tokenizes input by taking whitespace as delimiter. Now key value pair is made and
	...
	/**
	 * Reducer Reduce class is static and extends MapReduceBase and implements Reducer interface having four hadoop generics type Text, Text, Text,
	 * IntWritable.
	 */
	...
	/**
	 * Driver This method is used for setting all the configuration properties. It acts as a driver for map reduce code.
	 * 
	 * @return void
